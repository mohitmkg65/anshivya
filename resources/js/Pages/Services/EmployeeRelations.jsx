...
import { FileSpreadsheet, AlertTriangle, ArrowRight, HelpCircle } from 'lucide-react';

export default function EmployeeRelations() {
  const service = servicesData.find(s => s.id === 'employee-relations');

  return (
    <Layout
      title="Employee Relations & Engagement Support"
      description="Proactive employee relations frameworks, grievance redressal setups, and culture alignment."
    >
      ...
      <section className="py-20 bg-slate-900/40 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-12">
            <span className="text-xs font-bold uppercase tracking-widest text-amber-400">CULTURE ISSUES</span>
            <h2 className="text-3xl font-extrabold text-white tracking-tight mt-1">
              Workplace Disconnects We Resolve
            </h2>
          </div>
      ...
      <section className="py-24 bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-16">
            <span className="text-xs font-bold uppercase tracking-widest text-amber-400">ENGAGEMENT FRAMEWORK</span>
            <h2 className="text-3xl font-extrabold text-white tracking-tight mt-1">
              Structured Employee Relations Process
            </h2>
          </div>
