...
import { Wallet, AlertTriangle, ArrowRight, HelpCircle } from 'lucide-react';

export default function Payroll() {
  const service = servicesData.find(s => s.id === 'payroll');

  return (
    <Layout
      title="Payroll Management & HRMS Implementation"
      description="Organized monthly payroll processes, clearer reporting, coordination, and enhanced operational visibility."
    >
      {/* SERVICE HERO */}
      ...
      <section className="py-20 bg-slate-900/40 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-12">
            <span className="text-xs font-bold uppercase tracking-widest text-amber-400">OPERATIONAL FRICTION SOLVED</span>
            <h2 className="text-3xl font-extrabold text-white tracking-tight mt-1">
              Payroll Issues We Resolve
            </h2>
          </div>
      ...
      <section className="py-24 bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-16">
            <span className="text-xs font-bold uppercase tracking-widest text-amber-400">MONTHLY CYCLE</span>
            <h2 className="text-3xl font-extrabold text-white tracking-tight mt-1">
              4-Step Payroll Execution Process
            </h2>
          </div>
